...
// which has additional links.
    ...
    if(Transmit)
    {
        transmit_data[0] = IMU1.q[0]; transmit_data[1] = IMU1.q[1];
        transmit_data[2] = IMU1.q[2]; transmit_data[3] = IMU1.q[3];
        transmit_data[4] = IMU2.q[0]; transmit_data[5] = IMU2.q[1];
        transmit_data[6] = IMU2.q[2]; transmit_data[7] = IMU2.q[3];
