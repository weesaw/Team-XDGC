...
void setup() {
  ...
  analogWrite(AD0_pin, 168);
  // TWBR = 12;  // 400 kbit/sec I2C speed
  Serial.begin(38400);
  //Serial.print(IMU1.getAddr(),HEX);
  //Serial.print(F("MPU1 has address 0x"));
  byte c1 = IMU1.readByte(IMU1.getAddr(), WHO_AM_I_MPU9250);
  byte c2 = IMU2.readByte(0x69, WHO_AM_I_MPU9250);
  Serial.print(F("MPU1 has address 0x"));
  Serial.println(c1, HEX);
  Serial.print(F("MPU2 has address 0x"));
  Serial.println(c2, HEX);

  if (c1 == 0x71) // WHO_AM_I should always be 0x71
  {
    Serial.println(F("MPU1 is online..."));
    ...
    // communication
    byte d = mag_reg_rd(IMU1, WHO_AM_I_AK8963);
