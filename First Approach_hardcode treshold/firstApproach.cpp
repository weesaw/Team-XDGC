...
void check_ax1(float max, float min, uint8_t * output)
{
    ...
    if (max<0.1 && min>-0.1)
        ...
        output[0] = 0;
    if (max<0.25 && min>-1)
        output[1] = 1; else output[1] = 0;
    if (max<0.25 && min>-2)
        output[2] = 1; else output[2] = 0;
    if (max<0.25 && min>-2)
        output[3] = 1; else output[3] = 0;
    if (max<0.05 && min>-0.15)
        output[4] = 1; else output[4] = 0;
    if (max<0.1 && min>-2.25)
        output[5] = 1; else output[5] = 0;
}
