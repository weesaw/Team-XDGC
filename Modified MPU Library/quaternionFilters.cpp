...
//static float eInt1[3] = {0.0f, 0.0f, 0.0f};
//static float eInt2[3] = {0.0f, 0.0f, 0.0f};
// Vector to hold quaternion
//static float q_1[4] = {1.0f, 0.0f, 0.0f, 0.0f};
//static float q_2[4] = {1.0f, 0.0f, 0.0f, 0.0f};
...
void MahonyQuaternionUpdate(float * q, float * eInt, float ax, float ay, float az, float gx, float gy, float gz, float mx, float my, float mz, float deltat)
{
  // short name local variable for readability
  float q1 = q[0], q2 = q[1], q3 = q[2], q4 = q[3];
  /*if (num == 1)
...
//const float * getQ1 () { return q_1; }

//const float * getQ2 () { return q_2; }
