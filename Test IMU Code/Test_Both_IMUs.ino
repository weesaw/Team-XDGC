...
void loop() {
  ...
  if ((IMU1.readByte(IMU1.getAddr(), INT_STATUS) & 0x01) && (IMU2.readByte(IMU2.getAddr(), INT_STATUS) & 0x01))
  {
...
/*
    IMU1.yaw   = atan2(2.0f * (*(getQ1()+1) * *(getQ1()+2) + *getQ1()
                  * *(getQ1()+3)), *getQ1() * *getQ1() + *(getQ1()+1)
                  * *(getQ1()+1) - *(getQ1()+2) * *(getQ1()+2) - *(getQ1()+3)
                  * *(getQ1()+3));
*/    
    //IMU1.pitch = -asin(2.0f * (*(getQ1()+1) * *(getQ1()+3) - *getQ1()* *(getQ1()+2)));
...
/*
    IMU1.roll  = atan2(2.0f * (*getQ1() * (*(getQ1()+1)) + *(getQ1()+2)* (*(getQ1()+3))),
                      (*getQ1()) * (*getQ1()) - *(getQ1()+1)* (*(getQ1()+1)) - *(getQ1()+2) * (*(getQ1()+2)) + *(getQ1()+3)* (*(getQ1()+3)));*/
